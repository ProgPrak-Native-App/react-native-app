  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        <ImageBackground source={require('../../../assets/securitynetIcon.png')} style={{ height: 180, width: 180, justifyContent:'space-between'}}>
          ...
          <Pressable onPress={() => navigation.navigate('SecurityNetItem', {component: empty})}>
            <Image source={require('../../../assets/icon_plus.png')} style={{ height: 48, width: 48, alignSelf:'center', marginTop: 10}} />
          </Pressable>
        </ImageBackground>
      </View>
