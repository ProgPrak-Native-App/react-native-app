...
import {Text, Modal, View, StyleSheet, Pressable, ScrollView } from 'react-native'
import { ORANGE, PRIMARY, PURPLE, SIZES } from '../../styles'
import { SocialSupportStackParamList } from './SocialNavigation';

const textLvl1 = [
    { heading: "", text:"Für diese Übung trägst Du Menschen aus Deinem Umfeld in folgendes Schema ein. Du selbst bist der Mittelpunkt."},
    { heading: "Innerer Kreis:", text: "Trage hier die wichtigsten Menschen in deinem Leben ein."},
    { heading: "Mittlerere Kreis:", text: "Trage hier Personen ein, die dir noch nahe stehen und/oder mit denen du regelmäßig Zeit verbringst."},
    { heading : "Äußerer Kreis:", text:"Trage hier Bekannte und eher entferntere Personen ein, mit denen du aber auch ab und zu zu tun hast."}
]
const textLvl2 = [
    { 
        icon: "❤️📚 💪", 
