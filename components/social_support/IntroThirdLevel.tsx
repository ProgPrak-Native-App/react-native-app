...
import { ORANGE, SIZES, TERTIARY } from '../../styles'
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container} >
        ...
        <Text style={styles.body}>So wie andere dich unterstützen, kannst du natürlich auch umgekehrt andere unterstützen oder tust 
